...
- I get that Level 1 is supposed to be easy, but it is probably a bit *too* easy; I feel like I should have worked for the flag a bit more, instead of having it basically be handed to you as soon as you use the right forensic tool to dump the hidden binary. Difficulty-wise, I think [last year's Level 1]({% post_url 2022-09-12-tisc-2022 %}#1-slay-the-dragon) was perfect.
...
- As mentioned previously, 6A was far, far, far, far too easy - for comparison, [2021's level 4]({% post_url 2021-12-11-tisc-2021 %}#4-the-magicians-den) was harder than this.
